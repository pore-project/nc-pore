...
NC-PoRE architecture decisions are documented as individual ADR files.

This document provides an overview and navigation entry.
...
- ADR-004 Upload After Recording
...
Public ADRs document the architecture intended for publication. Internal ADRs document architectural and product information that is not intended for automatic public disclosure.
