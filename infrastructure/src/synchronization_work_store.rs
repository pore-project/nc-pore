//! Filesystem persistence for application synchronization work.
//!
//! The application layer defines the SynchronizationWorkStore contract; this
//! module supplies the concrete local filesystem implementation.
...
mod tests {
    ...
    fn filesystem_store_recovers_interrupted_work_after_reconstruction() {
        ...
        let mut first =
            PersistentSynchronizationQueue::new(FilesystemSynchronizationWorkStore::new(&root));
        first
            .enqueue(RecordingArtifactId::new("artifact-002"), manifest_hash(2))
            .unwrap();
